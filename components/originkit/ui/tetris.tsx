...
const FALLBACK_COLORS = ["#F9731A", "#FFFFFF", "#3B82F6", "#10B981", "#8B5CF6", "#EC4899"];
...
export function __OriginkitBase_Tetris(props: TetrisProps) {
  const {
    boardColor = "rgba(15, 23, 42, 0.6)",
    colors = ["#F9731A", "#3B82F6", "#10B981", "#EC4899", "#8B5CF6", "#F59E0B"],
    movement = 4,
    cellSize = 26,
    gap = 1.5,
    rounded = 12,
...
export default function Tetris(props: Record<string, unknown>) {
  return <__OriginkitBase_Tetris {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
