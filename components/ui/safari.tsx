  ...
  return (
    ...
    >
      ...
      {!hasVideo && !imageSrc && children && (
        <div
          className="absolute z-0 overflow-auto bg-white dark:bg-[#1e1e1e]"
          style={{
            left: `${LEFT_PCT}%`,
            top: `${TOP_PCT}%`,
            width: `${WIDTH_PCT}%`,
      ...
      >
        ...
        >
          ...
          <circle
            ...
            cy="25"
            r="6"
            className="fill-[#27c93f]"
          />
          <path
            d="M286 17C286 13.6863 288.686 11 292 11H946C949.314 11 952 13.6863 952 17V35C952 38.3137 949.314 41 946 41H292C288.686 41 286 38.3137 286 35V17Z"
            className="fill-[#f1f5f9] dark:fill-[#334155]"
          />
