...
export function ImagesBadge({
  ...
  return (
    <Component
      ...
      onClick={onClick}
      className={cn(
        "inline-flex cursor-pointer items-center gap-3.5 perspective-[1000px] transform-3d group",
        className,
      )}
    >
      {/* Folder Container - Hover triggers exclusively on the icon element */}
      <motion.div
      ...
      >
        {/* Folder Back */}
        <div className="absolute inset-0 rounded-[4px] bg-gradient-to-b from-cyan-400 to-blue-500 shadow-sm dark:from-cyan-500 dark:to-blue-600">
          {/* Folder Tab */}
          <div
            className="absolute left-0.5 rounded-t-[2px] bg-gradient-to-b from-cyan-300 to-cyan-400 dark:from-cyan-400 dark:to-cyan-500"
            style={{
              top: -tabHeight * 0.65,
              width: tabWidth,
              height: tabHeight,
        ...
        <motion.div
          className="absolute inset-x-0 bottom-0 h-[85%] origin-bottom rounded-[4px] bg-gradient-to-b from-cyan-300 to-blue-400 shadow-sm dark:from-cyan-400 dark:to-blue-500"
          animate={{
        ...
        >
          {/* Folder line detail */}
          <div className="absolute top-1 right-1 left-1 h-px bg-cyan-200/50 dark:bg-cyan-300/50" />
        </motion.div>
      </motion.div>
