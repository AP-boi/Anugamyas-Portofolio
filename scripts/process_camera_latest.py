...
fname = "media_1788359640176.png"
img = Image.open(os.path.join(uploaded_dir, fname)).convert("RGBA")
w, h = img.size
pixels = img.load()

# Step 1: Detect and flood-fill outer white/light background
corner_colors = [
...
print(f"Saved camera.png to {out_path} (size={final_img.size}, corner alpha={final_img.getpixel((0,0))[3]})")
